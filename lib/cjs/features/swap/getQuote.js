...
function getQuote(_a) {
  return __awaiter(
    ...
    function* ({
      ...
      tokenOut,
      amountIn,
      sources = exports.DEFAULT_SOURCES,
      targetPools,
      excludedPools,
    }) {
      ...
      if (
        targetPools === null || targetPools === void 0
          ? void 0
          : targetPools.length
      ) {
        params.append(
          "target_pools",
          targetPools
            .map((v) => (0, utils_1.normalizeSuiObjectId)(v))
            .join(","),
        );
      }
      if (
        excludedPools === null || excludedPools === void 0
          ? void 0
          : excludedPools.length
      ) {
        params.append(
          "excluded_pools",
          excludedPools
