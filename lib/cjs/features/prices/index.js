...
function getTokenPrice(id_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function* (id, vsCoin = tokens_1.NATIVE_USDC_TOKEN_TYPE) {
      var _a;
      try {
        const response = yield fetch(
          `${exports.PRICES_API}/price?ids=${(0, token_1.normalizeTokenType)(id)}&vsCoin=${vsCoin}`,
        );
        const pricesRes = yield response.json();
        return Number(
          ((_a =
            pricesRes === null || pricesRes === void 0
              ? void 0
              : pricesRes[id]) === null || _a === void 0
            ? void 0
            : _a.price) || 0,
        );
      } catch (_) {
...
function getTokenPrices(ids_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function* (ids, vsCoin = tokens_1.NATIVE_USDC_TOKEN_TYPE) {
      try {
        const limitedIds = ids
          .slice(0, MAX_TOTAL_IDS)
          .map(token_1.normalizeTokenType);
        ...
        const combinedPrices = responses.reduce((acc, pricesRes) => {
          Object.keys(pricesRes).forEach((id) => {
            var _a;
            acc[id] = Number(
              ((_a = pricesRes[id]) === null || _a === void 0
                ? void 0
                : _a.price) || 0,
            );
          });
