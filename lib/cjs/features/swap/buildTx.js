      ...
      if (coinIn) {
        if (useCoinInDirectly) {
          const sumSplits = splits.reduce(
            (prev, curr) => prev.plus((0, bignumber_js_1.default)(curr)),
            new bignumber_js_1.default(0),
          );
          const splitPercentages = splits.map((split) =>
            new bignumber_js_1.default(split).div(sumSplits),
          );
          const precision = (0, bignumber_js_1.default)(1000000);
          ...
          coinData = tx.splitCoins(
            ...
            splitPercentages.map((p) =>
              tx.moveCall({
                target: `${math_1.MATH_PACKAGE_ID}::math::mul_factor`,
                arguments: [
                  amount,
                  tx.pure.u64(
                    p
      ...
      if (coinObjects.length > 0) {
        ...
        tx.moveCall({
          ...
          arguments: [
            ...
            coinInAmount !== null && coinInAmount !== void 0
              ? coinInAmount
