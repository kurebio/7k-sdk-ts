...
class SteammContract extends base_1.BaseContract {
  ...
  cpmmSwap(tx) {
    ...
    const [btokenA, bTokenB, _quoter, lp] = (0, utils_1.parseStructTag)(
      extra.poolStructTag,
    ).typeParams;
    const [lendingMarket, coinTypeA, _bTokenA] = (0, utils_1.parseStructTag)(
      extra.bankAStructTag,
    ).typeParams;
    const [_lendingMarket, coinTypeB, _bTokenB] = (0, utils_1.parseStructTag)(
      extra.bankBStructTag,
    ).typeParams;
  ...
  cpmmSwapV2(tx) {
    ...
    const bTokenOut = sui_1.SuiUtils.zeroCoin(
      tx,
      (0, utils_1.normalizeStructTag)(xToY ? bTokenB : btokenA),
    );
    // call swap on btoken
    tx.moveCall({
      ...
      arguments: [
        ...
        sui_1.SuiUtils.getCoinValue(
          (0, utils_1.normalizeStructTag)(xToY ? btokenA : bTokenB),
          bTokenIn,
          tx,
        ),
